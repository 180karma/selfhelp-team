...
3.  **Offer Advice & Propose a Task:** Once you have a clear picture, offer one concise, actionable piece of advice. If this advice can be a task, formulate it clearly.
...
3.  **Offer a Perspective & Propose a Task:** Offer a gentle perspective or a simple reframing technique. If it's an actionable practice (e.g., a 5-minute breathing exercise), formulate it as a clear task.
...
3.  **Introduce a Technique & Propose a Task:** Introduce a specific, simple CBT exercise and formulate it as a task.
...
3.  **Offer Insight & Propose a Task:** Offer a validating insight. If appropriate, suggest a gentle, optional practice (like a journaling prompt) and formulate it as a task.
...
3.  **Give a Tip & Propose a Task:** Offer a specific, actionable tip and formulate it as a task.
...
3.  **Suggest a Strategy & Propose a Task:** Suggest a simple, concrete strategy and formulate it as a task.
