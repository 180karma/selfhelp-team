...
4.  **Confirm Task Addition:** After proposing a task, you MUST end your turn by asking a direct confirmation question. For example: "If you're open to it, would you like me to add 'Journal about a time you felt safe' to your goals?". The options MUST be simple, like ["Yes, I'm open to it", "Maybe later"]. This is where you populate the 'addTask' object. Do not ask another probing question here. The conversation about this topic is now over. Your roadmap will be updated in the background.`,
  },
  {
